...
import { radiology } from "@/data/index";
    ...
    <div>
      ...
      <Container>
        <div className="w-fit space-y-2">
          ...
          <Heading
            CustomHeading={"Radiology"}
            CustomHeadingStyle={" uppercase"}
          />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 my-8">
            ...
            <Slider {...settings} className="slider-container relative  mb-8">
              {radiology.map((image, index) => (
                <Image
                  ...
                  width={1000}
                  height={500}
                  alt={`Slide object-cover ${index + 1}`}
                  className="  "
                />
              ))}
            </Slider>
          ...
          <div className="">
            <p className="text-sm text-zinc-600">
              Al Raza Hospital Laboratory is hospital-attached clinical
