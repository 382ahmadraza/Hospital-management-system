  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-70 sm:w-1/2 h-full  bg-white ">
        ...
        <div
          className="h-72 flex flex-col items-center sm:px-11"
        ...
        {/* nav links */}
        <ul className="flex flex-col items-center gap-5 text-sm font-bold">
      ...
      <span
        onClick={onClose}
        className="absolute top-4 left-70 sm:left-1/2 xs:ml-2 text-white"
      >
        <X size={40} />
      </span>
    </div>
